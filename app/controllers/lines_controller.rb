class LinesController < ApplicationController
  ...
  #   chart.add :axis_category_text, SoundReport.time_series
  #   chart.add :series, "Region A", SoundReport.report_for_region( "Region A" )
  #   chart.add :series, "Region B", SoundReport.report_for_region( "Region B" )
  #   chart.add :theme , "galeria"
  #   
  #   respond_to do |fmt|
  #     fmt.xml { render :xml => chart.to_xml }
  ...
  def load_line_2
    ...
    chart.add :composites, { :line4 => load_line_4_url }
    chart.add :theme , "galeria"
